...
public final class mh0 extends RuntimeException {
    ...
    public mh0(Iterable<? extends Throwable> iterable) {
        LinkedHashSet linkedHashSet = new LinkedHashSet();
        ArrayList arrayList = new ArrayList();
        if (iterable != null) {
            for (Throwable th : iterable) {
                if (th instanceof mh0) {
                    linkedHashSet.addAll(((mh0) th).c);
                } else if (th != null) {
        ...
        if (!linkedHashSet.isEmpty()) {
            ...
            this.d = this.c.size() + " exceptions occurred. ";
            return;
        }
