...
public class MessageContentBean {
    ...
    public boolean cancelFeedbackSound;
    public int comingSoundType;
    public String conditions;
    public int executeDelayTime;
    public int executeType;
    public MsgClose msgClose;
    public MsgShow msgShow;
    public boolean neverShow = false;
    public int permanent;
    public List<MsgPic> pics;
    public String sensingType;
    public ShowRules showRules;
    public String soundArea;
