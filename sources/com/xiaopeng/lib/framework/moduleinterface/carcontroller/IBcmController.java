...
public interface IBcmController extends ILifeCycle, com.xiaopeng.lib.framework.moduleinterface.carcontroller.v2extend.IBcmController {
    ...
    void setBCMBackDefrostMode(boolean mode);

    @Deprecated
    void setBCMBackMirrorHeatMode();

    @Deprecated
    void setBCMBackMirrorHeatMode(boolean mode);

    void setBCMSeatBlowLevel();

    void setBCMSeatBlowLevel(int level);

    void setBCMSeatHeatLevel();

    void setBCMSeatHeatLevel(int level);

    void setBackWindows(boolean open);

    void setChairPositionEnd();

    void setChairPositionStart(int level, int height, int angle);

    void setChairSlowlyAhead(int type);

    void setChairSlowlyBack(int type);

    void setChairSlowlyEnd(int type);

    void setChairWelcomeMode(boolean enable);

    void setChargeGunLock();

    void setChargingPortUnlock();

    void setCopilotWindowAuto(boolean enable);
    ...
    void setDriverWindowAuto(boolean enable);

    void setElectricSeatBelt(boolean enable);

    void setEmergencyBrakeWarning(boolean enable);

    void setFactoryOledData(byte[] data);

    void setFactoryOledDisplayMode(int mode);

    void setFrontWindows(boolean open);

    void setHazardLight(boolean on);

    void setHeadLampGroup(int groupid);

    void setInternalLight(boolean enable);

    void setLeftBackWindow(boolean open);

    void setLightMeHome(boolean enable);

    void setOled(int type);

    void setParkingAutoUnlock(boolean enable);

    void setPollingOpenCfg(boolean open);

    void setRearFogLamp(boolean enable);

    void setRearSeatBeltWarning(boolean enable);

    void setRearViewAutoDownCfg(int cfg);

    void setRearViewMirror(int type);

    void setRightBackWindow(boolean open);

    void setSeatFrHeatLevel(int level);
    ...
    void setWheelDefinedButton(int type);
