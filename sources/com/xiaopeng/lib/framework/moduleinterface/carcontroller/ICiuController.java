...
public interface ICiuController extends ILifeCycle {
    ...
    int getCiuAutoLockSt();

    boolean getCiuCarWash();

    int getCiuConfigurationActive();

    int getCiuDelayOff();

    int getCiuDeliveryUploadMode();

    int getCiuRainSw();

    int getCiuValid();

    int getDVRFormatStatus();

    int getDVRStatus();

    int getDeleteResult();

    int getDistractionLevel();
    ...
    int getFaceIdPrimalStatus();

    int getFaceIdStatus();

    int getFaceIdSw();

    boolean getFaceShield();
    ...
    void setCiuCarWash(boolean b);

    void setCiuConfigurationActive(int version);

    void setCiuDelayOff(int value);

    void setCiuDeliveryUploadMode(int mode);

    void setCiuRainSw(int level);

    void setDeleteFaceId(int delete);

    void setDeleteMulti(int uid, int deleteFaceId);

    void setDistractionStatus(int status);

    void setDmsMode(int mode);

    void setDmsStatus(int status);

    void setDmsStatus(int dmsStatus, int faceIdStatus, int fatigueStatus, int distractionStatus);

    void setDvrEnable(boolean enable);

    void setDvrLockMode(int mode);

    void setDvrMode(int mode);

    void setFaceActionRequest(int action);

    void setFaceIdMode(int mode);

    void setFaceIdSw(int value);

    void setFatIgStatus(int status);

    void setFatigueStatus(int status);

    void setFirmFaceCancel(int i);

    void setFormatMode(int mode);

    void setNotifyCiuAutoLightStatus(boolean enable);

    void setRegHint(int hint);

    void setRegisterRequestMulti(int uid, int faceActionRequest, int faceIdMode);

    void setStartRegFlag(int flag);

    void setStartRegFlow(int flow);

    void setUid(int uid);

    void setVideoOutputMode(int mode);

    void setVideoTimeLenMode(int mode);
}
