...
public interface IScuController {
    ...
    float[] getAltimeterV2();

    int getFsdSwitchState();

    int getParkByMemorySwSt();

    int[] getTargetParkingPositionV2();

    void setFsdSwitch(int onOff);

    void setParkByMemorySw(int sw);
}
