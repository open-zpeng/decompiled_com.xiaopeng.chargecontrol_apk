...
public class RemoteOperator {
    public static String TAG = "RemoteOperator";
    public String mAuthority;
    public IBinder.DeathRecipient mDeathRecipient;
    public String mDescription;
    public IBinder mIBinder;
    public AtomicBoolean mRemoteAlive = new AtomicBoolean(true);
    public Map<String, RemoteMethod> mRemoteApis;

    public RemoteOperator(IBinder iBinder, Map<String, RemoteMethod> map, String str, String str2) {
    ...
    public Object call(Uri uri, boolean z, byte[] bArr) {
        ...
        if (this.mDeathRecipient == null) {
            this.mDeathRecipient = new IBinder.DeathRecipient() { // from class: com.xiaopeng.lib.apirouter.RemoteOperator.1
                ...
                public void binderDied() {
                    ...
                    StringBuilder a = jg.a("binderDied:desc=");
                    a.append(RemoteOperator.this.mDescription);
                    a.append(", auth=");
                    a.append(RemoteOperator.this.mAuthority);
                    a.append(",rec=");
                    a.append(Integer.toHexString(hashCode()));
                    a.append(",obj=");
                    a.append(Integer.toHexString(RemoteOperator.this.hashCode()));
