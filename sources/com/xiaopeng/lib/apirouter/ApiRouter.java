...
public class ApiRouter {
    public static ApiMatcher mApiMatcher = new ApiMatcher();

    public static RemoteOperator publishModule(UriStruct uriStruct, IBinder iBinder, String str) {
        RemoteOperator fromJson = RemoteOperator.fromJson(iBinder, str);
        mApiMatcher.publishUri(uriStruct, fromJson);
        return fromJson;
    }

    public static <T> T route(Uri uri) {
        return (T) route(uri, false, null);
    }

    public static UriStruct toUriStruct(Uri uri) {
    ...
    public static RemoteOperator wakeRemoteService(UriStruct uriStruct) {
    ...
    public static <T> T route(Uri uri, byte[] bArr) {
        return (T) route(uri, true, bArr);
    }

    public static <T> T route(Uri uri, boolean z, byte[] bArr) {
