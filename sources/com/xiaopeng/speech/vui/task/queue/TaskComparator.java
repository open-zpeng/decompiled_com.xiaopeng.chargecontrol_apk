...
public class TaskComparator implements Comparator<BaseTask> {
    public static final String TAG = "TaskComparator";

    @Override // java.util.Comparator
    public int compare(BaseTask baseTask, BaseTask baseTask2) {
        if (baseTask != null && baseTask2 != null) {
            StringBuilder a = jg.a("Comparator: activeScene:  --  currentTask:");
            a.append(baseTask.getSceneId());
            a.append(" -- queueTask : ");
            a.append(baseTask2.getSceneId());
