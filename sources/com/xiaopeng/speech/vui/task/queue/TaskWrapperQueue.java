...
public class TaskWrapperQueue extends DeDuplicationQueue<String, BaseTask> {
    public String TAG = "TaskWrapperQueue";
    ...
    private boolean putTaskToQueue(BaseTask baseTask, boolean z) {
        ...
        LogUtils.d(str2, "队列缓存大小: offer:" + this.queue.size() + ",data" + this.queue.toString() + CFCHelper.SIGNAL_CFC_SPLIT + Thread.currentThread().getName());
        ...
        if (!TextUtils.isEmpty(vid) && this.map.containsKey(vid)) {
            ...
            if (baseTask2 != null && (taskWrapper2 = baseTask2.wrapper) != null) {
                if (taskWrapper2.getTaskType() == baseTask.wrapper.getTaskType()) {
            ...
            if (view != null && this.viewMap.containsKey(view)) {
                ...
                if (baseTask3 != null && (taskWrapper = baseTask3.wrapper) != null) {
                    if (taskWrapper.getTaskType() == baseTask.wrapper.getTaskType()) {
