...
public class DeDuplicationQueue<K, T extends BaseTask> implements BlockingQueue<T> {
    public static final String TAG = "DeDuplicationQueue";
    public final PriorityBlockingQueue<T> queue = new PriorityBlockingQueue<>(20, new TaskComparator());
    public final HashMap<K, T> map = new HashMap<>();
    public final HashMap<SoftReference<View>, T> viewMap = new HashMap<>();
    public final HashMap<K, List<BaseTask>> sceneMap = new HashMap<>();
    ...
    public void removeTaskFromSceneMap(BaseTask baseTask) {
        List<BaseTask> list;
        int indexOf;
        TaskWrapper taskWrapper = baseTask.wrapper;
        String sceneId = taskWrapper != null ? taskWrapper.getSceneId() : null;
    ...
    /* JADX WARN: Multi-variable type inference failed */
    @Override // java.util.concurrent.BlockingQueue
    public /* bridge */ /* synthetic */ boolean offer(Object obj, long j, TimeUnit timeUnit) {
