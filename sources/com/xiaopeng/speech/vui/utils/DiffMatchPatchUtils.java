...
import com.xiaopeng.lib.apirouter.ApiMatcher;
...
public class DiffMatchPatchUtils {
    ...
    public Pattern BLANKLINEEND = Pattern.compile("\\n\\r?\\n\\Z", 32);
    public Pattern BLANKLINESTART = Pattern.compile("\\A\\r?\\n\\r?\\n", 32);

    /* renamed from: com.xiaopeng.speech.vui.utils.DiffMatchPatchUtils$1  reason: invalid class name */
    /* loaded from: classes.dex */
    public static /* synthetic */ class AnonymousClass1 {
        public static final /* synthetic */ int[] $SwitchMap$com$xiaopeng$speech$vui$utils$DiffMatchPatchUtils$Operation = new int[Operation.values().length];
    ...
    public static class Patch {
        ...
        public String toString() {
            ...
            if (i == 0) {
                ...
                str = (this.start1 + 1) + CFCHelper.SIGNAL_CFC_SPLIT + this.length1;
            }
            int i2 = this.length2;
            if (i2 == 0) {
                str2 = this.start2 + ",0";
                ...
                str2 = (this.start2 + 1) + CFCHelper.SIGNAL_CFC_SPLIT + this.length2;
            }
    ...
    private LinkedList<Diff> diff_lineMode(String str, String str2, long j) {
        ...
        while (next != null) {
            ...
            if (ordinal == 0) {
                i++;
                StringBuilder a = jg.a(str5);
                a.append(next.text);
                str5 = a.toString();
            } else if (ordinal == 1) {
                i2++;
                StringBuilder a2 = jg.a(str6);
                a2.append(next.text);
                str6 = a2.toString();
            } else if (ordinal == 2) {
                if (i >= 1 && i2 >= 1) {
    ...
    private double match_bitapScore(int i, int i2, int i3, String str) {
        ...
        return (abs / i4) + length;
    }

    public static String unescapeForEncodeUriCompatability(String str) {
        return str.replace("%21", "!").replace("%7E", "~").replace("%27", "'").replace("%28", "(").replace("%29", ")").replace("%3B", IpcServiceImpl.PACKAGE_SPLIT).replace("%2F", "/").replace("%3F", "?").replace("%3A", ":").replace("%40", ApiMatcher.PROCESS_TAG_DIVIDER).replace("%26", "&").replace("%3D", "=").replace("%2B", "+").replace("%24", "$").replace("%2C", CFCHelper.SIGNAL_CFC_SPLIT).replace("%23", "#");
    }
    ...
    */
    public java.util.LinkedList<com.xiaopeng.speech.vui.utils.DiffMatchPatchUtils.Diff> diff_bisect(java.lang.String r26, java.lang.String r27, long r28) {
        /*
    ...
    public void diff_charsToLines(List<Diff> list, List<String> list2) {
        for (Diff diff : list) {
            StringBuilder sb = new StringBuilder();
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:46:0x0112 A[LOOP:0: B:15:0x0037->B:46:0x0112, LOOP_END] */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public void diff_cleanupSemanticLossless(java.util.LinkedList<com.xiaopeng.speech.vui.utils.DiffMatchPatchUtils.Diff> r17) {
        /*
    ...
    public int diff_commonOverlap(String str, String str2) {
            ...
            if (str3.length() != 0) {
                ...
                if (charAt == '+') {
                    ...
                    try {
                        ...
                        throw new IllegalArgumentException(jg.a("Illegal escape in diff_fromDelta: ", replace), e2);
                    }
                } else if (charAt != '-' && charAt != '=') {
                    StringBuilder a = jg.a("Invalid diff operation in diff_fromDelta: ");
                    a.append(str3.charAt(0));
                    ...
                    try {
                        ...
                        if (parseInt >= 0) {
                            ...
                            throw new IllegalArgumentException(jg.a("Negative number in diff_fromDelta: ", substring));
                        }
                    } catch (NumberFormatException e4) {
                        throw new IllegalArgumentException(jg.a("Invalid number in diff_fromDelta: ", substring), e4);
                    }
                }
            }
        }
    ...
    public String[] diff_halfMatch(String str, String str2) {
        if (this.Diff_Timeout <= XToggleDrawable.LIGHT_RADIUS_DEFAULT) {
            return null;
        }
        String str3 = str.length() > str2.length() ? str : str2;
        String str4 = str.length() > str2.length() ? str2 : str;
    ...
    public LinesToCharsResult diff_linesToChars(String str, String str2) {
    ...
    public int diff_xIndex(List<Diff> list, int i) {
        ...
        return (diff == null || diff.operation != Operation.DELETE) ? (i - i5) + i4 : i4;
    }

    public Map<Character, Integer> match_alphabet(String str) {
        HashMap hashMap = new HashMap();
    ...
    public int match_bitap(String str, String str2, int i) {
        ...
        while (i5 < str2.length()) {
            ...
            int i7 = length2;
            while (i6 < length2) {
                if (match_bitapScore(i5, i + length2, i, str2) <= d2) {
                    i6 = length2;
                } else {
                    i7 = length2;
                }
            ...
            while (true) {
                ...
                int i8 = max;
                int i9 = length3 - 1;
                int intValue = (str.length() <= i9 || !match_alphabet.containsKey(Character.valueOf(str.charAt(i9)))) ? 0 : match_alphabet.get(Character.valueOf(str.charAt(i9))).intValue();
                if (i5 == 0) {
                ...
                if ((iArr2[length3] & length) != 0) {
                    double match_bitapScore = match_bitapScore(i5, i9, i, str2);
                    if (match_bitapScore <= d2) {
                        if (i9 <= i) {
                            i4 = 1;
                            i2 = i9;
                            d2 = match_bitapScore;
            ...
            i5++;
            if (match_bitapScore(i5, i, i, str2) > d2) {
                break;
            }
            iArr = iArr2;
            i3 = 0;
    ...
    public void patch_addContext(Patch patch, String str) {
        if (str.length() == 0) {
            return;
        }
        int i = patch.start2;
        String substring = str.substring(i, patch.length1 + i);
        int i2 = 0;
        while (str.indexOf(substring) != str.lastIndexOf(substring)) {
            ...
            i2 += s2;
            substring = str.substring(Math.max(0, patch.start2 - i2), Math.min(str.length(), patch.start2 + patch.length1 + i2));
        }
        int i3 = i2 + this.Patch_Margin;
        String substring2 = str.substring(Math.max(0, patch.start2 - i3), patch.start2);
        if (substring2.length() != 0) {
            patch.diffs.addFirst(new Diff(Operation.EQUAL, substring2));
        }
        String substring3 = str.substring(patch.start2 + patch.length1, Math.min(str.length(), patch.start2 + patch.length1 + i3));
    ...
    public String patch_addPadding(LinkedList<Patch> linkedList) {
        ...
        for (short s2 = 1; s2 <= s; s2 = (short) (s2 + 1)) {
            ...
            a.append(String.valueOf((char) s2));
            str = a.toString();
        }
        ...
        if (!linkedList2.isEmpty() && linkedList2.getFirst().operation == Operation.EQUAL) {
            if (s > linkedList2.getFirst().text.length()) {
    ...
    */
                ...
                while (true) {
                    if (!linkedList2.isEmpty()) {
                        ...
                        try {
                            ...
                            throw new IllegalArgumentException(jg.a("Illegal escape in patch_fromText: ", replace), e2);
                        }
                    }
                }
            } else {
                StringBuilder a = jg.a("Invalid patch string: ");
                a.append((String) linkedList2.getFirst());
                throw new IllegalArgumentException(a.toString());
            }
        }
        return linkedList;
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:6:0x001b -> B:7:0x001d). Please submit an issue!!! */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public void patch_splitMax(java.util.LinkedList<com.xiaopeng.speech.vui.utils.DiffMatchPatchUtils.Patch> r17) {
        /*
    ...
    public LinkedList<Diff> diff_main(String str, String str2, boolean z) {
        return diff_main(str, str2, z, this.Diff_Timeout <= XToggleDrawable.LIGHT_RADIUS_DEFAULT ? Long.MAX_VALUE : System.currentTimeMillis() + (this.Diff_Timeout * 1000.0f));
    }
    ...
    public LinkedList<Patch> patch_make(String str, LinkedList<Diff> linkedList) {
        if (str != null && linkedList != null) {
            ...
            while (it.hasNext()) {
                ...
                int ordinal = next.operation.ordinal();
                if (ordinal == 0) {
                    patch.length1 = next.text.length() + patch.length1;
                    patch.diffs.add(next);
                    str2 = str2.substring(0, i2) + str2.substring(next.text.length() + i2);
                } else if (ordinal == 1) {
                    patch.diffs.add(next);
                    patch.length2 = next.text.length() + patch.length2;
