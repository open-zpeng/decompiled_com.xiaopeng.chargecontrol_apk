...
public class LogUtils {
    ...
    */
    public static void doLog(int r4, java.lang.Object r5, java.lang.String r6, java.lang.Throwable r7, boolean r8) {
        /*
            r0 = 0
            if (r8 == 0) goto L20
    ...
    public static String msgForTextLog(String str, int i, String str2, Throwable th, boolean z) {
        StringBuilder a = jg.a(str2);
        if (z) {
            a.append(" (T:");
