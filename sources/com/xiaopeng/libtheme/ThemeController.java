...
public class ThemeController {
    public static final int MSG_STATE_NOTIFY = 1001;
    public static final int MSG_STATE_TIMEOUT = 1002;
    ...
    public static final String TAG = "ThemeController";
    public static final int VIEW_DISABLE = 0;
    public static final int VIEW_ENABLED = 1;
    public static final int VIEW_UNKNOWN = -1;
    public Context mContext;
    public final ThemeObserver mThemeObserver;
    ...
    public static final String KEY_DAYNIGHT_MODE = "ui_night_mode";
    ...
    public static ThemeController sThemeController = null;
    public int mThemeMode = 0;
    public int mThemeState = 0;
    public int mDaynightMode = 0;
    public int mViewState = -1;
    public final Handler mHandler = new Handler(Looper.getMainLooper()) { // from class: com.xiaopeng.libtheme.ThemeController.1
    ...
    public ArrayList<OnThemeListener> mThemeListeners = new ArrayList<>();
    ...
    public class ThemeObserver {
        ...
        public final ContentObserver mThemeObserver;
    ...
    public void readThemeSettings() {
        ...
        StringBuilder a = jg.a("readThemeSettings themeState=");
        a.append(this.mThemeState);
        a.append(" daynightMode=");
        a.append(this.mDaynightMode);
        ThemeManager.Logger.log(TAG, a.toString());
    }
