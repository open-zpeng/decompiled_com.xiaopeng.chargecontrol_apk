...
public class ThemeViewModel {
    public HashMap<String, Integer> mAttributeSet;
    public OnCallback mCallback;
    public List<OnCallback> mCallbacks = new ArrayList();
    public int mUiMode;
    ...
    public ThemeViewModel(Context context, HashMap<String, Integer> hashMap) {
    ...
    private void updateThemeResource(View view) {
        if (ThemeManager.DEBUG) {
            StringBuilder a = jg.a("ThemeViewModel updateThemeResource view=");
            a.append(getViewInfo(view));
            a.append(" attr=");
            a.append(getAttrInfo());
