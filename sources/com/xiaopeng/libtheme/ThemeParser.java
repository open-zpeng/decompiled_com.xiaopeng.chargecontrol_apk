...
public class ThemeParser {
    ...
    public static final String NODE = "view";
    public static final String TAG = "ThemeXmlParser";
    ...
    public static ThemeView resolveThemeView(Context context, ThemeView themeView) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(themeView.xmlValue) && themeView.xmlValue.startsWith(ApiMatcher.PROCESS_TAG_DIVIDER) && themeView.xmlValue.contains("/")) {
                String str = themeView.xmlValue;
                String substring = str.substring(1, str.indexOf("/"));
                String str2 = themeView.xmlValue;
                int identifier = resources.getIdentifier(str2.substring(str2.indexOf("/") + 1), substring, packageName);
