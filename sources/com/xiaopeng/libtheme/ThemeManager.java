...
public class ThemeManager {
    ...
    public ThemeData mThemeData = new ThemeData();
    ...
    public static class ResourceType {
        ...
        static {
            ...
            sResourceType.put(ThemeParser._ATTR, 2);
    ...
    public static class ViewBuilder {
        public List<ThemeView> list = new ArrayList();
    ...
    public ThemeManager(Context context, View view, String str, List<ThemeView> list) {
