...
public class ThemeWrapper {
    public static final String TAG = "ThemeWrapper";
    public static final long TIMEOUT = 5000;
    public static final int TYPE_DRAWABLE_BOTTOM = 3;
    public static final int TYPE_DRAWABLE_END = 5;
    public static final int TYPE_DRAWABLE_LEFT = 0;
    public static final int TYPE_DRAWABLE_RIGHT = 2;
    public static final int TYPE_DRAWABLE_START = 4;
    public static final int TYPE_DRAWABLE_TOP = 1;
    public static HashMap<String, List<ThemeView>> sThemeCache;
    public Handler mHandler = new WorkHandler();
    public static final boolean DEBUG = ThemeManager.DEBUG;
    public static volatile ThemeWrapper sThemeWrapper = null;

    /* loaded from: classes.dex */
    public static class WorkHandler extends Handler {
        public static final int MSG_HANDLER_TIMEOUT = 100;
    ...
    public static Drawable getOverlayDrawable(Drawable drawable, Drawable drawable2) {
    ...
    public static int getThemeResourceId(int i, Context context, AttributeSet attributeSet, int i2, int i3) {
        TypedArray obtainStyledAttributes = context != null ? context.getTheme().obtainStyledAttributes(attributeSet, new int[]{i}, i2, i3) : null;
    ...
    public static String getViewInfo(View view, int i, String str) {
    ...
    public static void invokeViewResource(Context context, View view, String str, int i) {
        try {
    ...
    public void onTimeout() {
        ...
        this.mHandler = null;
        if (DEBUG) {
            StringBuilder a = jg.a("onTimeout time=");
            a.append(now());
            ThemeManager.Logger.log(a.toString());
        }
    }
            ...
            for (int i3 = 0; i3 < attributeCount; i3++) {
                try {
                    ...
                    if (!TextUtils.isEmpty(attributeName) && !TextUtils.isEmpty(attributeValue)) {
                        boolean z3 = (ThemeManager.AttributeSet.hasAttribute(attributeName) || (list != null && list.contains(attributeName))) && attributeValue.startsWith(ApiMatcher.PROCESS_TAG_DIVIDER);
        ...
        if (z || z2) {
            for (String str : hashMap2.keySet()) {
                ...
                if (intValue != 0 && !hashMap3.containsKey(str)) {
                    ...
                    if (DEBUG) {
                        StringBuilder a = jg.a("resolveAttribute theme&style attr key=", str, " resId=0x");
                        a.append(Integer.toHexString(themeResourceId));
                        a.append(" hasTheme=");
                        a.append(z);
                        a.append(" hasStyle=");
                        a.append(z2);
        ...
        if (list2 != null && !list2.isEmpty()) {
            for (String str3 : list2) {
                if (!TextUtils.isEmpty(str3) && !hashMap3.containsKey(str3) && hashMap2.containsKey(str3)) {
                    ...
                    if (DEBUG) {
                        StringBuilder a2 = jg.a("resolveAttribute global attr key=", str3, " resId=0x");
                        a2.append(Integer.toHexString(themeResourceId3));
                        ThemeManager.Logger.log(a2.toString());
                    }
    ...
    public static void setCompoundDrawables(int i, android.widget.TextView textView, Drawable drawable) {
    ...
    public static void setViewResource(Context context, View view, String str, int i) {
        ...
        try {
            if (ThemeManager.AttributeSet.ALPHA.equals(str)) {
                ...
                view.setBackground(getOverlayDrawable(p7.b(applicationContext, i), view.getBackground()));
            } else if (ThemeManager.AttributeSet.FOREGROUND.equals(str)) {
                int i2 = Build.VERSION.SDK_INT;
                view.setForeground(getOverlayDrawable(p7.b(applicationContext, i), view.getForeground()));
            } else if (ThemeManager.AttributeSet.SCROLLBAR_THUMB_VERTICAL.equals(str)) {
                setVerticalThumbDrawable(view, p7.b(applicationContext, i));
            } else if (ThemeManager.AttributeSet.SRC.equals(str)) {
                if (view instanceof ImageView) {
                    ImageView imageView = (ImageView) view;
                    imageView.setImageDrawable(getOverlayDrawable(p7.b(applicationContext, i), imageView.getDrawable()));
                }
            } else if (ThemeManager.AttributeSet.TEXT_COLOR.equals(str)) {
                if (view instanceof android.widget.TextView) {
                    ((android.widget.TextView) view).setTextColor(p7.a(applicationContext, i));
                }
            } else if (ThemeManager.AttributeSet.TEXT_COLOR_HINT.equals(str)) {
                if (view instanceof android.widget.TextView) {
                    ((android.widget.TextView) view).setHintTextColor(p7.a(applicationContext, i));
                }
            } else if (ThemeManager.AttributeSet.DRAWABLE_LEFT.equals(str)) {
                if (view instanceof android.widget.TextView) {
                    setCompoundDrawables(0, (android.widget.TextView) view, p7.b(applicationContext, i));
                }
            } else if (ThemeManager.AttributeSet.DRAWABLE_TOP.equals(str)) {
                if (view instanceof android.widget.TextView) {
                    setCompoundDrawables(1, (android.widget.TextView) view, p7.b(applicationContext, i));
                }
            } else if (ThemeManager.AttributeSet.DRAWABLE_RIGHT.equals(str)) {
                if (view instanceof android.widget.TextView) {
                    setCompoundDrawables(2, (android.widget.TextView) view, p7.b(applicationContext, i));
                }
            } else if (ThemeManager.AttributeSet.DRAWABLE_BOTTOM.equals(str)) {
                if (view instanceof android.widget.TextView) {
                    setCompoundDrawables(3, (android.widget.TextView) view, p7.b(applicationContext, i));
                }
            } else if (ThemeManager.AttributeSet.DRAWABLE_START.equals(str)) {
                if (view instanceof android.widget.TextView) {
                    setCompoundDrawables(4, (android.widget.TextView) view, p7.b(applicationContext, i));
                }
            } else if (ThemeManager.AttributeSet.DRAWABLE_END.equals(str)) {
                if (view instanceof android.widget.TextView) {
                    setCompoundDrawables(5, (android.widget.TextView) view, p7.b(applicationContext, i));
                }
            } else if (ThemeManager.AttributeSet.PROGRESS_DRAWABLE.equals(str)) {
                if (view instanceof ProgressBar) {
                    ((ProgressBar) view).setProgressDrawable(p7.b(applicationContext, i));
                }
            } else if (ThemeManager.AttributeSet.THUMB.equals(str)) {
                if (view instanceof SeekBar) {
                    ((SeekBar) view).setThumb(p7.b(applicationContext, i));
                }
            } else if (ThemeManager.AttributeSet.BUTTON.equals(str)) {
                if (view instanceof CompoundButton) {
                    ((CompoundButton) view).setButtonDrawable(p7.b(applicationContext, i));
                }
            } else if (ThemeManager.AttributeSet.DIVIDER.equals(str) && (view instanceof ListView)) {
                ((ListView) view).setDivider(p7.b(applicationContext, i));
            }
    ...
    public static void startImageDrawableTransition(final ImageView imageView, final Drawable drawable, final Drawable drawable2) {
    ...
    public static void startTextColorTransition(final android.widget.TextView textView, final int i, final int i2) {
    ...
    public static void startViewBackgroundTransition(final View view, final Drawable drawable, final Drawable drawable2) {
    ...
    public static void startTextColorTransition(final android.widget.TextView textView, final int i, final ColorStateList colorStateList) {
