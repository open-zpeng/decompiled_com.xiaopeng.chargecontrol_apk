...
public class XCheckBoxDrawable extends Drawable {
    ...
    public ColorStateList mColorBg;
    public ColorStateList mColorFront;
    public ColorStateList mColorInner;
    public float mDrawablePadding;
    public float mFrameWidth;
    public Path mNikePath;
    public Paint mPaint;

    @Override // android.graphics.drawable.Drawable
    public void draw(Canvas canvas) {
        this.mPaint.setStyle(Paint.Style.FILL);
        this.mPaint.setColor(this.mColorBg.getColorForState(getState(), vc0.x_check_box_inner_color));
        ...
        if (StateSet.stateSetMatches(CHECKED_STATE_SET, getState())) {
            this.mPaint.setStyle(Paint.Style.FILL);
            this.mPaint.setColor(this.mColorFront.getColorForState(getState(), vc0.x_check_box_frame_color));
            ...
            this.mPaint.setColor(this.mColorInner.getColorForState(getState(), vc0.x_radio_inner_color_selector));
    ...
    public void inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        this.mColorBg = resources.getColorStateList(vc0.x_check_box_inner_color, theme);
        this.mColorFront = resources.getColorStateList(vc0.x_check_box_frame_color, theme);
        this.mColorInner = resources.getColorStateList(vc0.x_radio_inner_color_selector, theme);
